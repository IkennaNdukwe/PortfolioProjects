...
-- death_rate shows likelihood of dying if covid is contracted per country 
...
-- infection_rate shows percentage of population infected by the corona virus 
select location, date, population, total_cases, (cast(total_cases as float)/population)*100 as 'infection_rate'
from covid.deaths
where location = "Nigeria"
-- where location like '%states%'

-- countries with highest infection rate per to population
...
-- countries with highest death rate per to population
